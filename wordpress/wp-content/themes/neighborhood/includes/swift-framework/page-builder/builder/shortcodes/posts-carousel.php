...
class SwiftPageBuilderShortcode_posts_carousel extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
			...
			$items .= '<div class="carousel-overflow"><ul id="carousel-'.$carouselID.'" class="blog-items carousel-items clearfix" data-columns="'.$columns.'">';
...
SPBMap::map( 'posts_carousel', array(
    "name"		=> __("Posts Carousel", "swift_page_builder"),
    "base"		=> "posts_carousel",
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => "12",
            "description" => __("The number of blog items to show in the carousel.", "swift_page_builder")
        ),
        array(
            "type" => "select-multiple",
            "heading" => __("Posts category", "swift_page_builder"),
            "param_name" => "category",
