...
class SwiftPageBuilderShortcode_team_carousel extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
    		...
    		if( have_posts() ) {
    			...
    			$items .= '<div class="carousel-overflow"><ul id="carousel-'.$carouselID.'" class="team-members carousel-items '.$list_class.' clearfix" data-columns="'.$columns.'">';
...
SPBMap::map( 'team_carousel', array(
    "name"		=> __("Team Carousel", "swift_page_builder"),
    "base"		=> "team_carousel",
