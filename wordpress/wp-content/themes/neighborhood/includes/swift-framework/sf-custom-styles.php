<?php
	...
	*/
	...
	function sf_custom_styles() {
		...
		global $post;
		if ($post) {
		$background_image_size = get_post_meta($post->ID, 'sf_background_image_size', true);
		}
		...
		echo 'h1, h2, h3, h4, h5, .custom-caption p, span.dropcap1, span.dropcap2, span.dropcap3, span.dropcap4, .spb_call_text, .impact-text, .testimonial-text, .header-advert {font-family: "'.$heading_font.'", Arial, Helvetica, Tahoma, sans-serif;}'. "\n";
		...
		// HEADER STYLES
		echo "\n".'/*========== Header Styles ==========*/'."\n";
		echo '#super-search .search-options .ss-dropdown > span, #super-search .search-options input {color: '.$accent_color.'; border-bottom-color: '.$accent_color.';}'. "\n";
		echo '#super-search .search-options .ss-dropdown ul li .icon-ok { color: '.$accent_color.';}'. "\n";
		echo '#super-search-go:hover, #super-search-close:hover { background-color: '.$accent_color.'; border-color: '.$accent_color.'; color: '.$accent_alt_color.';}'. "\n";
		...
		echo '.bag-buttons a.checkout-button, .bag-buttons a.create-account-button, .woocommerce input.button.alt, .woocommerce .alt-button, .woocommerce button.button.alt {background: '.$secondary_accent_color.'; color: '.$secondary_accent_alt_color.';}'. "\n";
		echo '.bag-buttons a:hover, .woocommerce .button.update-cart-button:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}'. "\n";
		echo '.bag-buttons a.checkout-button:hover, .woocommerce input.button.alt:hover, .woocommerce .alt-button:hover, .woocommerce button.button.alt:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}'. "\n";
		...
		echo '.carousel-wrap a.prev, .carousel-wrap a.next {background: '.$secondary_accent_color.'; color: '.$secondary_accent_alt_color.'!important;}'. "\n";
		echo '.carousel-wrap a.prev:hover, .carousel-wrap a.next:hover {color: '.$accent_color.'!important;}'. "\n";
		...
		echo '.alt-two h4.spb_text_heading, .alt-two h4.spb_heading {border-bottom-color:'.$alt_two_text_color.';}'. "\n";
		...
		echo '.alt-three h4.spb_text_heading, .alt-three h4.spb_heading {border-bottom-color:'.$alt_three_text_color.';}'. "\n";
		...
		echo '.alt-four h4.spb_text_heading, .alt-four h4.spb_heading {border-bottom-color:'.$alt_four_text_color.';}'. "\n";
		...
		echo '.alt-five h4.spb_text_heading, .alt-five h4.spb_heading {border-bottom-color:'.$alt_five_text_color.';}'. "\n";
		...
		echo '.alt-six h4.spb_text_heading, .alt-six h4.spb_heading {border-bottom-color:'.$alt_six_text_color.';}'. "\n";
		...
		echo '.alt-seven h4.spb_text_heading, .alt-seven h4.spb_heading {border-bottom-color:'.$alt_seven_text_color.';}'. "\n";
		...
		echo '.alt-eight h4.spb_text_heading, .alt-eight h4.spb_heading {border-bottom-color:'.$alt_eight_text_color.';}'. "\n";
		...
		echo '.alt-nine h4.spb_text_heading, .alt-nine h4.spb_heading {border-bottom-color:'.$alt_nine_text_color.';}'. "\n";				
		...
		echo '.alt-ten h4.spb_text_heading, .alt-ten h4.spb_heading {border-bottom-color:'.$alt_ten_text_color.';}'. "\n";
		...
		$replace_with = 'h1, h2, h3, h4, h5, .heading-font, .custom-caption p, span.dropcap1, span.dropcap2, span.dropcap3, span.dropcap4, .spb_call_text, .impact-text, .testimonial-text, .header-advert, .spb_call_text, .impact-text {';
