...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		...
		<a href="<?php echo esc_url( add_query_arg('address', $name, get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ); ?>" class="edit-address"><?php echo sprintf( __('Edit %s address', 'swiftframework' ), $name); ?></a>
