...
if ( !class_exists( 'GW_GoPricing' ) ) {
	class GW_GoPricing {
		...
		public function go_pricing_register_menu_page() {
			add_menu_page('Go - Pricing & Compare Tables', 'Go Pricing', 'manage_options', 'go-pricing', array( $this, 'go_pricing_menu_page_callback' ) , plugin_dir_url( __FILE__ ) . '/admin/images/icon_wp_nav.png', 90);
		...
		public function go_pricing_register_submenu_page() {
			add_submenu_page( 'go-pricing', 'General Settings', 'General Settings', 'manage_options', 'go-pricing-settings', array( $this, 'go_pricing_submenu_page_settings_callback' ) );
			add_submenu_page( 'go-pricing', 'Import & export', 'Import & export', 'manage_options', 'go-pricing-import-export', array( $this, 'go_pricing_submenu_page_import_export_callback' ) );			
		}
		...
		public function go_pricing_register_js() {
			wp_register_script( GW_GO_PREFIX . 'scripts', plugin_dir_url( __FILE__ ) . 'assets/js/go_pricing_scripts.js', 'jquery', GW_GO_VER );
			wp_register_script( GW_GO_PREFIX . 'googlemap', 'http://maps.google.com/maps/api/js?sensor=false', false, '1.0' );
			wp_register_script( GW_GO_PREFIX . 'jqplugin-gomap', plugin_dir_url( __FILE__ ). 'assets/plugins/js/jquery.gomap-1.3.2.min.js', 'jquery, ' . GW_GO_PREFIX . 'googlemap', '1.3.2' );
			global $wp_version;
			if ( version_compare( $wp_version, 3.6, "<" ) ) {	
				wp_register_script( GW_GO_PREFIX . 'jqplugin-mediaelementjs', plugin_dir_url( __FILE__ ) . 'assets/plugins/js/mediaelementjs/mediaelement-and-player.min.js', 'jquery', GW_GO_VER ); 		
			}
		}
				...
				if ( !empty( $pricing_tables ) ) {
					...
					foreach ( $pricing_tables as $pricing_table ) {
						if 	( isset ( $pricing_table['table-id'] ) && $pricing_table['table-id'] == $id ) {
							...
							for ( $x = 0; $x < $colnum ; $x++ ) {
								list( $col_style ) = explode( '_', $pricing_table['col-style'][$x] );
								...
								list( , $col_type ) = explode( '_', $pricing_table['col-style'][$x] );
								$generated_table .= '<div class="gw-go-col-wrap' . ( $pricing_table['col-highlight'][$x] == '1' ? ' gw-go-current' : '' ) . '">';
								...
								/* header */
								if ( $pricing_table['col-replace'][$x]=='1' ) {
								...
								if ( isset( $pricing_table['col-button-text'][$x] ) && ($pricing_table['col-button-text'][$x] != '' || $pricing_table['col-button-type'][$x] == 'custom' ) ) {
									if ( isset( $pricing_table['col-button-type'][$x] ) && $pricing_table['col-button-type'][$x] == 'button' ) {
										$generated_table.='<a href="' . esc_attr( $pricing_table['col-button-link'][$x] ) . '" class="gw-go-btn gw-go-btn-' . ( $pricing_table['col-button-size'][$x] ) . '"' . ( $pricing_table['col-button-target'][$x] == '1' ? ' target="_blank"' : '') . '>' . do_shortcode( $pricing_table['col-button-text'][$x] ) . '</a>';
                ...
                <div id="go-pricing-settings-wrapper" class="postbox">
                    ...
                    <div class="inside go-pricing-thumbs-wrapper">
						...
						if ( isset( $filename[1] ) && file_exists( plugin_dir_path( __FILE__ ) . 'assets/images/thumbnails/' . $filename[1] . '.jpg' ) ) {
							...
							$imgsrc = $plugin_dir_url . 'assets/images/thumbnails/custom.jpg';
						}
		                ?>
                ...
                <div id="go-pricing-column-wrapper" class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <li class="go-pricing-column">
                            ...
                            <div class="inside">
                                <table class="form-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="col-button-link[]" class="w255"><?php echo isset( $pricing_tables[$uniqid]['col-button-link'][$x] ) ? esc_attr( $pricing_tables[$uniqid]['col-button-link'][$x] ) : '' ; ?></textarea></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="inside postbox go-pricing-column-controls"><a href="#" class="go-pricing-remove-column button-secondary"><span class="go-pricing-button-icon-remove"></span><?php _e( 'Delete column', GW_GO_TEXTDOMAN ); ?></a><a href="#" class="go-pricing-clone-column button-secondary" ><span class="go-pricing-button-icon-clone"></span><?php _e( 'Clone column', GW_GO_TEXTDOMAN ); ?></a><a href="#" class="go-pricing-collapse-column button-secondary" data-closed="<?php _e( 'Expand all', GW_GO_TEXTDOMAN ); ?>" data-open="<?php _e( 'Collapse all', GW_GO_TEXTDOMAN ); ?>"><span class="go-pricing-button-icon-collapse"></span><?php _e( 'Expand all', GW_GO_TEXTDOMAN ); ?></a></div>                        
                        </li>
                            <?php
							endfor;
							endif;
                    ...
                    <div class="inside">
                    	<table class="form-table">
                            <tr>
                                ...
                                <td class="w200"><input type="text" name="primary-font" id="go-pricing-primary-font" value="<?php echo isset( $table_settings['primary-font'] ) ? esc_attr( $table_settings['primary-font'] ) : ''; ?>" class="w180" /></td>
                            ...
                            <tr>
                                ...
                                <td class="w200"><input type="text" name="primary-font-css" id="go-pricing-primary-font-css" value="<?php echo isset( $table_settings['primary-font-css'] ) ? ( $table_settings['primary-font-css'] ) : ''; ?>" class="w180" /></td>
                            ...
                            <tr>
                                ...
                                <td class="w200"><input type="text" name="secondary-font" id="go-pricing-secondary-font" value="<?php echo isset( $table_settings['secondary-font'] ) ? esc_attr( $table_settings['secondary-font'] ) : ''; ?>" class="w180" /></td>
                            ...
                            <tr>
                                ...
                                <td class="w200"><input type="text" name="secondary-font-css" id="go-pricing-secondary-font-css" value="<?php echo isset( $table_settings['secondary-font-css'] ) ? ( $table_settings['secondary-font-css'] ) : ''; ?>" class="w180" /></td>
...
<?php _e( 'After clicking to the "Save" button your changes will appear in css file.', GW_GO_TEXTDOMAN ); ?>
		...
		/* Import & export page */
		public function go_pricing_submenu_page_import_export_callback( $response=array() ) {
			?>
			<div id="go-pricing-admin-wrap" class="wrap" data-id="<?php echo $_SERVER['REQUEST_URI']; ?>">
		    <div id="go-pricing-admin-icon" class="icon32"></div>
		    <h2><?php _e( 'Go - Responsive Pricing & Compare Tables', GW_GO_TEXTDOMAN ); ?></h2>
			...
			$pricing_tables = get_option( GW_GO_PREFIX . 'tables' );
			?>
            <form id="go-pricing-import-export-form" name="import-export-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" data-ajaxerrormsg="<?php _e( 'Oops, AJAX error!', GW_GO_TEXTDOMAN ); ?>">
                <input type="hidden" name="nonce" value="<?php echo wp_create_nonce( GW_GO_PREFIX . basename( __FILE__ ) ); ?>" />
                <input type="hidden" id="action-type" name="action-type" value="edit" />
                <div id="go-pricing-admin-wrap-wrapper" class="postbox">
                    <h3 class="hndle"><?php _e( 'Data import & export', GW_GO_TEXTDOMAN ); ?><span></span></h3>
                    <div class="inside">
                        <table class="form-table">
                            <tr>
                            	<th>
                                	<ol>
                            			<li><?php _e( '<strong>Import data:</strong> To import demo data open the file that contains demodata, copy its content to the textarea below and click to import button.', GW_GO_TEXTDOMAN ); ?></li>
                                		<li><?php _e( '<strong>Export data:</strong> To export demo copy the content of the textare below and save into file on your hard drive.', GW_GO_TEXTDOMAN ); ?></li>
									</ol>
                                </th>
                            </tr>
                            <tr>
                            	<th><textarea id="go-pricing-table-data" name="table-data" style="width:100%;" rows="10"><?php echo !empty( $pricing_tables ) ? base64_encode( serialize( $pricing_tables ) ) : ''; ?></textarea></th>
                           </tr>
                        </table>
                    </div>
                </div>            
                <p class="submit">
                    <input name="save" type="button" class="button-primary go-pricing-save" value="<?php esc_attr_e( 'Import', GW_GO_TEXTDOMAN ); ?>" />
                    <img src="<?php echo admin_url(); ?>/images/wpspin_light.gif" class="ajax-loading" alt="" />
                </p>
            </form>
        	<?php 
		...
		public function go_pricing_import_export_ajax_submit() {
			$response=array();
			...
			$new_pricing_tables = unserialize(base64_decode($_POST['table-data']));
			...
			if ( !isset( $response['result'] ) || $response['result'] != 'error' ) {
				if ( $pricing_tables != $new_pricing_tables  ) { update_option ( GW_GO_PREFIX . 'tables', $new_pricing_tables ); }
				$response['result'] = 'success';
				$response['message'][] = __( 'Table data has been successfully imported.', GW_GO_TEXTDOMAN );
			}	
			$this->go_pricing_submenu_page_import_export_callback( $response );
			exit;	
		}
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr class="go-pricing-popup-sc go_pricing_image">
                        ...
                        <td class="w100"><a href="#" class="go-pricing-add-img-input go-pricing-popup-tb button-secondary" style="margin:1px 3px; padding: 4px 8px !important;"><span class="go-pricing-button-icon-add"></span><?php _e( 'Add', GW_GO_TEXTDOMAN ); ?></a></td>
                    </tr>
                    <tr class="go-pricing-popup-sc go_pricing_image">
                    ...
                    <tr class="go-pricing-popup-sc go_pricing_youtube go_pricing_vimeo go_pricing_screenr">
                    ...
                    <tr class="go-pricing-popup-sc go_pricing_html5_video">
                        ...
                        <td class="w100"><a href="#" class="go-pricing-add-file-input go-pricing-popup-tb button-secondary" style="margin:1px 3px; padding: 4px 8px !important;"><span class="go-pricing-button-icon-add"></span><?php _e( 'Add', GW_GO_TEXTDOMAN ); ?></a></td>
                    </tr>
                    <tr class="go-pricing-popup-sc go_pricing_html5_video">
                ...
                <strong><?php _e( 'Leave blank to use the default marker.', GW_GO_TEXTDOMAN ); ?></strong></p></td>
                        <td class="w100"><a href="#" class="go-pricing-add-file-input go-pricing-popup-tb button-secondary" style="margin:1px 3px; padding: 4px 8px !important;"><span class="go-pricing-button-icon-add"></span>Add</a></td>
                    </tr>                    
                    <tr class="go-pricing-popup-sc go_pricing_map">
