...
if($_SERVER["HTTP_HOST"]=="127.0.0.21" || $_SERVER["HTTP_HOST"]=="push.com")
{
...
else if($_SERVER["HTTP_HOST"]=="music-push.com")
{
...
$table_prefix  = 'tb_music_';
define('WPLANG', "zh_CN");
}
else if($_SERVER["HTTP_HOST"]=="stock2000.com")
{
define('DB_NAME', 'www2');
define('DB_USER', 'root');
define('DB_PASSWORD', '');
...
else if($_SERVER["HTTP_HOST"]=="photo.com")
{
define('DB_NAME', 'www2');
define('DB_USER', 'root');
define('DB_PASSWORD', '');
